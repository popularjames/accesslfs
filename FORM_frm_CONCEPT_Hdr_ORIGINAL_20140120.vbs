...
'Debug.Assert oCtl.Name <> "ConceptGroup"
...
Stop
    ...
    Else
        ...
        If Me.IsPayerSetToAll = True Then
            ...
            Else
'Stop
                DoCmd.OpenReport "rpt_CONCEPT_New_Issue_CMS_Only", acViewPreview, , "ConceptID = '" & Me.FormConceptID & "'"
...
Dim sPayerList As String
    ...
    Else
        ...
        Else
            ...
            Else
                sPayerList = GetPayerNameFromID(CLng(vPayerNameID))
