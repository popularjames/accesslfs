...
Private Const csTmpTableName As String = "tmp_NIRF_Editor_Samples"
...
Dim oFrm As Form_frm_CONCEPT_NIRF_Editor_Samples_Revert_List
...
Dim strFormName As String
    ...
    Set oFrm = New Form_frm_CONCEPT_NIRF_Editor_Samples_Revert_List
...
'    Me.OpenArgs = "CM_C2052 AND PayerNameid = 1008 "
    sFilter = " WHERE ConceptId = 'CM_C1974' AND PayerNameId = 1008 "
    ...
    sSql = "SELECT * FROM v_CONCEPT_NIRF_Samples_W_Edits " & sFilter
    ...
    Set Me.RecordSet = Nothing
    Me.RecordSource = csTmpTableName
...
Dim oCmd As ADODB.Command
    ...
    With oCmd
        ...
        .CommandText = "usp_CONCEPT_NIRF_Save_Sample_Manual_Changes"
...
'    oCn.Execute "EXEC CMS_AUDITORS_CODE.dbo.usp_CONCEPT_NIRF_Save_Universe_Manual_Changes @pConceptId = '" & Me.ConceptID & "', @pPayerNameId = " & CStr(Me.PayerNameID)
    ...
    With oRs
        ...
        .Open ("SELECT ManualEditId, ConceptId, PayerNameId, PayerName, CnlyClaimNum,ICN, SampleState, StateName, ClmFromDt, RecoveryAmount, ConceptLevel, LoadDt, NIRF_FinTypeId, LastUser  FROM CONCEPT_NIRF_Samples_Edits WHERE 1 = 2")
        ''-- disconnect:
