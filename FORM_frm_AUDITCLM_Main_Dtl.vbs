...
'    If (Nz(Me.Adj_Units, 0) <> 0 Or Nz(Me.Adj_HCPCS, "") <> "" Or Nz(Me.Adj_ProjectedSavings, 0) <> 0 Or Nz(Me.Adj_Mod01, "") <> "" Or Nz(Me.Adj_Mod02, "") <> "" Or Nz(Me.Adj_Mod03, "") <> "" Or Nz(Me.Adj_Mod04, "") <> "" Or Nz(Me.Adj_Mod05, "") <> "" Or Nz(Me.Adj_DischargeStatus, "") <> "" Or Nz(Me.cboConceptCd, "") <> "") _
'    And Nz(Me.cmoIndicator, "") <> "Y" Then
'        MsgBox "Cannot adjust this line without Adj_Indicator as Y", vbCritical
'        Me.Undo
'    End If
End Sub
