...
Public Function AddLetterInstance(sInstanceId As String, sQueueStatus As String, sProvNum As String, ByVal sLetterType As String, Optional ByVal lContractId As Long = 100) As Boolean
On Error GoTo Block_Err
Dim strProcName As String
Dim oLtr As clsLetterInstance
    ...
    If cdctLetters.Exists(sInstanceId) = False Then
        ...
        ' eventually we'll probably have QR codes for all letters..
        oLtr.LoadQRCodePath
