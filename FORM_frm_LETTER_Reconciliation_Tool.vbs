...
Dim lDupCount As Long
    ...
    Call ProcessFolder(Me.txtFolderToProcess, Me)
    Me.TimerInterval = 0
    ...
    lDupCount = Nz(DLookup("CountOfProvNum", "qry_LETTER_Reconciliation_Tool_Counts"), Me.txtLettersFound)
    lProvCount = Nz(DCount("ProvNum", "qry_LETTER_Reconciliation_Tool"), 0)
    
    'Me.txtProvNums = lProvCount
    
'    If Trim(Me.txtProvNums) = Trim(Me.txtLettersFound) Then
    If Nz(lDupCount, 0) = 0 Then
