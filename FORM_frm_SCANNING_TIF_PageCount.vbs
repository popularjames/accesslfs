...
Private Sub Form_Load()
    ...
    If UCase(left(strScannedStation, 9)) <> "SN-PHILLY" Then
        MsgBox "This function is only available on scan station", vbInformation
