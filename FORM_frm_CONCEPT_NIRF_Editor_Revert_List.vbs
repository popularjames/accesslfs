...
Private clAutoIdSelected As Long

Public Property Get ClassName() As String
    ClassName = TypeName(Me)
End Property

Public Property Get AutoIdSelected() As Long
    AutoIdSelected = clAutoIdSelected
End Property
Public Property Let AutoIdSelected(lAutoIdSelected As Long)
    clAutoIdSelected = lAutoIdSelected
End Property
...
Dim sSql As String
    ...
    sSql = "SELECT AutoId, ArchiveDt, LastUpUser FROM CMS_AUDITORS_CLAIMS.dbo.CONCEPT_NIRF_ManualEdits_Hist " & _
...
' Ok, here, capture the row
    Me.AutoIdSelected = Me.txtAutoId.Value
    ...
    With oAdo
        ...
        .sqlString = "usp_CONCEPT_NIRF_Editor_Revert_To_Id"
        .Parameters.Refresh
        .Parameters("@pConceptId") = Me.ConceptID
        .Parameters("@pPayerNameId") = Me.PayerNameId
        .Parameters("@pSelectedAutoId") = Me.AutoIdSelected
        .Execute
        ...
        Else
            ' all good to go -
            RaiseEvent AutoIdWasPicked(Me.txtAutoId.Value)
            Me.visible = False
        End If
    End With
...
Private Sub txtAutoId_DblClick(Cancel As Integer)
    Call SelectedRow
End Sub

Private Sub txtLastUpUser_DblClick(Cancel As Integer)
    Call SelectedRow
End Sub
