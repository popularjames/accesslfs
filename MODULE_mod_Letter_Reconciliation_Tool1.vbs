...
''
''    Call PrepCoverSheet(sFldr, sLetterType, sLtrReqDt, sSelectedPrinter)
''
''
...
''End Function
''
''Private Sub PrepCoverSheet(sFldr As String, sLetterType As String, sLtrReqDt As String, sSelectedPrinter As String)
''On Error GoTo Block_Err
''Dim strProcName As String
''Dim oFso As Scripting.FileSystemObject
''Dim oFldr As Scripting.Folder
...
'''Stop
''
''        lPageCnt = lPageCnt + DLookup("PageCount", "LETTER_Static_Details", "InstanceId = '" & sInstanceId & "'")
''        lLtrCnt = lLtrCnt + 1
''
''
''    Next
