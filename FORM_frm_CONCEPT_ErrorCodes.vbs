...
Private Const CstrFrmAppID As String = "ConceptErrorCodes"
...
'Dim intRowID As Integer
    ...
    strSQL = ""
    strSQL = strSQL & "DELETE FROM CONCEPT_Error_Codes "
    strSQL = strSQL & " WHERE ConceptID = '" & Me.ConceptID & "'"
    strSQL = strSQL & " and ErrorCodeId = " & Me.ErrorCodeID
    strSQL = strSQL & " and ErrorCode = " & CStr("" & Me.ErrorCode)
...
Dim iAppPermission As Integer
    ...
    If IsSubForm(Me) = True Then
        ...
        sRecordSource = "SELECT * FROM v_CONCEPT_ErrorCodes_Form WHERE ConceptID = '" & _
                Me.Parent.Form.txtConceptID & "' "
        ...
        Me.RecordSource = sRecordSource
    Else
        Me.RecordSource = "SELECT * FROM v_CONCEPT_ErrorCodes_Form"
        Me.cmbPayer.RowSource = " SELECT PayerNameID, PayerName FROM XREF_PAYERNAMES WHERE PayerNameID = 1000 "
    End If
