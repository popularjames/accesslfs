...
''Stop
        ...
        If bFirst = True Then
            ...
            If UnlinkWordFields(oWord, oMergedDoc) = False Then
...
'
'Private Function UnlinkWordFields(oWordApp As Word.Application, oDoc As Word.Document, Optional sLetterType As String = "") As Boolean
'On Error GoTo Block_Err
'Dim strProcName As String
'Dim objWordField As Word.Field
'Dim objWordSection As Word.Section
