...
Private Sub cmdExportToExcel_Click()
    ...
    bExport = ExportDetails(Me.lstDetail.RecordSet, "MonthlyDrgReport.xls")
...
Public Sub RefreshData()
    ...
    strRPTTableName = Replace(Identity.UserName(), ".", "_") & "_Adhoc_HUMANA_Monthly_DRG_Report"
    myCode_ADO.SQLTextType = sqltext
    myCode_ADO.sqlString = "exec usp_RPT_HUMANA_Monthly_DRG '" & Identity.UserName() & "', '" & Format(FromDt, "mm-dd-yyyy") & "','" & Format(ThruDt, "mm-dd-yyyy") & "'"
